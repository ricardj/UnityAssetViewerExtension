...
import { parsePrefabComplete, type LocalRepoProvider } from '../src/index';

describe('parsePrefabComplete (Recursive Variant Resolution)', () => {
...
`;
    ...
    // 2. Setup the mock LocalRepoProvider
    const mockRepo: LocalRepoProvider = {
    ...
    const parsed = await parsePrefabComplete(childYaml, mockRepo);
